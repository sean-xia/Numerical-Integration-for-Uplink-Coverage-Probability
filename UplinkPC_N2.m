...
I2 = @(r) integral(@(x) I1_arr(x,r).*x, 0,inf,"arrayvalued",true,"AbsTol",1e-6,"RelTol",1e-6);
% vectorization
I2_arr = @(r) arrayfun(@(r) I2(r),r);

% The outer integration
pc = 2*pi*l*integral(@(r) r.*exp(-pi*l.*r.^2).*exp(-2*pi*l*I2_arr(r)),0,inf, ...
